...
const Sitemap: React.FC = () => {
  const pages = [
    ...
    // Tasks
    { path: '/tasks', name: '📋 Tasks Dashboard', category: 'Tasks' },
    { path: '/tasks/list', name: '📝 Lista de Tasks', category: 'Tasks' },
    { path: '/tasks/create', name: '➕ Criar Nova Task', category: 'Tasks' },
    
    // Orchestration
    { path: '/orchestration', name: '🎭 Orchestration Dashboard', category: 'Orchestration' },
    { path: '/orchestration/submit', name: '🚀 Submit Orchestration', category: 'Orchestration' },
